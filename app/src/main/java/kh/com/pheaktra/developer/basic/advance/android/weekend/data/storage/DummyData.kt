...
val componentList = listOf(
    ...
    MaterialComponentModel(
        42,
        "Pick Single Photo",
        "Media picker in android for picking media picker",
    ...
    MaterialComponentModel(
        44,
        "Pick Single Video",
        "Media picker in android for picking single video",
    ...
    MaterialComponentModel(
        45,
        "Pick Multiple Video",
        "Media picker in android for picking multiple video",
    ...
    MaterialComponentModel(
        46,
        "Pick Video & Photo",
        "Media picker in android for picking video and photo",
